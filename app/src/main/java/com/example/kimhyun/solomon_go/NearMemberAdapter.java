...
public class NearMemberAdapter extends BaseAdapter {
    ...
    ArrayList<NearMember> datas;

    LayoutInflater inflater;



    public NearMemberAdapter(LayoutInflater inflater, ArrayList<NearMember> datas) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView text_name= (TextView)convertView.findViewById(R.id.textView_list_name);

        TextView text_nation= (TextView)convertView.findViewById(R.id.textView_list_age);

        ImageView img_flag= (ImageView)convertView.findViewById(R.id.imageView_picture);
        ...
        text_nation.setText( datas.get(position).getAge() );

        img_flag.setImageBitmap( datas.get(position).getImgId() );
